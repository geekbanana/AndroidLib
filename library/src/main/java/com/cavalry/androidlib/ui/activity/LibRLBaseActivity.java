...
/**
 * 可以指定任意View具有Refresh和Loadmore功能的Activity
 *
 * <p>1.{@link #setRLMode(PtrFrameLayout.Mode)}设置具有refresh还是loadmore功能, 默认二者皆有, 在setContentView之前使用有效</p>
...
public abstract class LibRLBaseActivity extends LibBaseActivity {
    private static final String TAG = "LibRLBaseActivity";

    private PtrFrameLayout mPtrFrameLayout;
    private PtrFrameLayout.Mode mRLMode = PtrFrameLayout.Mode.BOTH;

    /**
     * 设置是否可以下拉刷新和上拉加载,默认两者皆可.  在setContentView之前调用生效.
     * @param rlMode
     */
    ...
    private LibPtrFrameLayout initPtrFrameLayout(){
        LibPtrFrameLayout ptrFrameLayout =  new LibPtrFrameLayout(getBaseContext());
